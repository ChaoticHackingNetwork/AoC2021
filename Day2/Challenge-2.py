...
after following the planned course. What do you get if you multiply your final horizontal position by your final depth?
"""
...
with open('trav_path.txt', 'r') as f:
	for line in f:
		cmd, arg = line.split()
		amount = int(arg)
		if cmd == 'forward':
...
answer = int(depth) * int(horz_pos)
print(f"Part 2: Depth * horzizontal position -> {answer}")
